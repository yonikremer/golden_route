...
class MyTestCase(unittest.TestCase):
    def test_is_valid_charge_mass(self):
        ...
        self.assertTrue(business_logic.is_valid_charge_mass(business_logic.maximal_charge_mass))
    ...
    def test_is_valid_charge_mass_string(self):
        ...
        self.assertFalse(business_logic.is_valid_charge_mass_string("wbudwbwdb"))
        self.assertRaises(TypeError, business_logic.is_valid_charge_mass)
